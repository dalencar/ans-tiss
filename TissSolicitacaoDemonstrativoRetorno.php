...
if (!class_exists("TissSolicitacaoDemonstrativoRetorno", false)) {
    ...
    include_once('dadosPrestadorOdontologia.php');
    ...
    include_once('dadosContratadoPagamento.php');
    ...
    class TissSolicitacaoDemonstrativoRetorno extends \SoapClient {
        ...
        private static $classmap = array(
            ...
            'dadosContratado' => '\\dadosContratadoPagamento',
            ...
            'dadosPrestador' => '\\dadosPrestadorOdontologia',
